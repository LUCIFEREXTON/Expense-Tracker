...
import UsedelayEffect from './../../Components/UsedelayEffect';
			...
			<div className={style.row}>			
				...
				<div className={style.balance}>
					...
					<UsedelayEffect
						...
						component={<div className={style.total} onClick={toggle}>Total Balance</div>}
						delay={900}
						showClass='show'
						hideClass='hide'
					/>
					<UsedelayEffect
						show={showTotal}
						setshow={setShowTotal}
						component={<div className={style.total} onClick={toggle}>Rs. 25000</div>}
						delay={900}
						showClass='show'
						hideClass='hide'
					/>					
